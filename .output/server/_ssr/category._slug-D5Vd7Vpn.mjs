...
import { M as notFound, f as lazyRouteComponent, h as Link, p as createFileRoute } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/category._slug-D5Vd7Vpn.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter$1 = () => import("./shop-7yT9Be6-.mjs");
var Route$1 = createFileRoute("/shop")({
	head: () => ({ meta: [{ title: "Shop all — Ateliér" }, {
		name: "description",
		content: "Every product, filtered your way."
	}] }),
	loader: ({ context }) => {
...
var $$splitComponentImporter = () => import("./category._slug-B2bl_uU6.mjs");
var $$splitNotFoundComponentImporter = () => import("./category._slug-CIwkt1GF.mjs");
var Route = createFileRoute("/category/$slug")({
	loader: async ({ context, params }) => {
		const cat = (await context.queryClient.ensureQueryData(categoriesQuery())).find((c) => c.slug === params.slug);
	...
	head: ({ loaderData }) => ({ meta: loaderData ? [
		...
		{
			property: "og:title",
			content: `${loaderData.cat.name} — Ateliér`
		},
		{
		...
		...loaderData.cat.image_url ? [{
			property: "og:image",
			content: loaderData.cat.image_url
		}] : []
	] : [{ title: "Category" }, {
		name: "robots",
		content: "noindex"
...
//#endregion
export { Route$1 as n, ShopView as r, Route as t };
